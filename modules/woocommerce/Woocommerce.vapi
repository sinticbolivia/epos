...
namespace EPos {
	namespace Woocommerce {
		...
		public class SBWCSync : GLib.Object {
			...
			public long SyncProducts (int store_id, EPos.Woocommerce.SyncCallback? cb = null, GLib.FileProgressCallback? progress_callback = null);
		...
		[CCode (cheader_filename = "Woocommerce.h")]
		public class WindowSyncProductsProgress : Gtk.Window {
			protected Gtk.Box box1;
			public Gtk.Button buttonCancel;
			public Gtk.Label labelBytes;
			public Gtk.Label labelImportedProducts;
			public Gtk.Label labelProductName;
			public Gtk.Label labelTotalProducts;
			public Gtk.ProgressBar progressbarDownload;
			public Gtk.ProgressBar progressbarGlobal;
			protected Gtk.Builder ui;
